...
import { Plane, MapPin, Calendar, Heart, Users, SparklesIcon as Champagne, Music, Navigation, Menu, X } from "lucide-react"
...
export default function HomePage() {
      ...
      <div className="h-screen bg-gradient-to-b from-blue-400 via-blue-300 to-blue-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4">
          <div className="relative w-full max-w-sm md:w-96">
            {/* Window Frame */}
            <div className="w-full h-48 md:h-64 bg-gray-800 rounded-3xl p-4 shadow-2xl">
              <div className="w-full h-full bg-gradient-to-b from-blue-400 via-blue-300 to-green-200 rounded-2xl relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white px-4">
                    ...
                    >
                      <p className="text-base md:text-lg font-light tracking-wide">Approaching Mexico City...</p>
                      <p className="text-xs md:text-sm opacity-80 mt-2">Friday, April 3, 2026</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Status Bar */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 px-4">
          <div className="bg-black/80 text-white px-4 md:px-6 py-3 rounded-full backdrop-blur-sm">
            <p className="text-xs md:text-sm font-light tracking-wide">Flight Status: Landing Soon</p>
          </div>
        </div>
      </div>
    )
  ...
  if (currentScene === "arrival") {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 relative overflow-y-auto">
        {/* Runway Lights */}
        ...
        <div className="relative flex items-center justify-center px-4 py-8 min-h-screen">
          <div className="text-center text-white w-full max-w-4xl">
            ...
            >
              ...
              {/* Authentic Boarding Pass Design - Mobile Responsive */}
              <div
                className="bg-white text-gray-800 rounded-lg shadow-2xl w-full mx-auto mb-6 md:mb-8 overflow-hidden"
              >
                {/* Red Header */}
                <div className="bg-[rgb(228,198,191)] text-[rgb(88,104,127)] px-4 md:px-8 py-3 flex justify-between items-center">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <span className="font-bold text-sm md:text-lg tracking-wide">BOARDING PASS</span>
                    <Plane className="h-4 w-4 md:h-5 md:w-5" />
                  </div>
                  <div className="text-right">
                    <span className="font-bold text-xs md:text-sm tracking-wider">BOARDING PASS</span>
                  </div>
                </div>
                  ...
                  <div className="md:mr-20">
                    <div className="grid grid-cols-2 md:flex md:justify-between md:items-start mb-4 md:mb-6 gap-4 md:gap-8">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-bold text-sm md:text-lg">You</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Flight</p>
                        <p className="font-bold text-sm md:text-lg">LOVE2026</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">From</p>
                        <p className="font-bold text-sm md:text-lg">Everywhere</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">To</p>
                        <p className="font-bold text-sm md:text-lg">Mexico City</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Date</p>
                        <p className="font-bold text-sm md:text-lg">FRI 03 APR</p>
                      </div>
                    </div>

                    {/* Center Airplane */}
                    <div className="text-center mb-4 md:mb-6">
                      <Plane className="h-6 w-6 md:h-8 md:w-8 text-[rgb(88,104,127)] mx-auto mb-2" />
                      <div className="flex justify-center space-x-1">
                        {[...Array(12)].map((_, i) => (
                          <span key={i} className="text-[rgb(88,104,127)] text-xs md:text-sm">
                            ★
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="border-t border-dashed border-gray-300 my-3 md:my-4"></div>

                    <div className="grid grid-cols-2 md:flex md:justify-between md:items-start text-sm gap-4 md:gap-8">
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Seat</p>
                        <p className="font-bold text-sm md:text-lg">VIP</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Class</p>
                        <p className="font-bold text-sm md:text-lg">First</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Duration</p>
                        <p className="font-bold text-sm md:text-lg">Weekend</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Boarding</p>
                        <p className="font-bold text-sm md:text-lg">Anytime</p>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs uppercase tracking-wide text-gray-500 mb-1 md:mb-2">Gate</p>
                        <p className="font-bold text-sm md:text-lg">LOVE</p>
                      </div>
                    </div>
                  </div>

                  {/* Right QR Code - Hidden on mobile */}
                  <div className="hidden md:block absolute right-4 top-4 w-12 h-12 border-2 border-[rgb(88,104,127)] flex items-center justify-center">
              ...
              <Button
                ...
                size="lg"
                className="bg-[rgb(228,198,191)] hover:bg-[rgb(228,198,191)]/80 text-[rgb(88,104,127)] font-semibold px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg shadow-xl transform hover:scale-105 transition-all duration-300"
              >
  ...
  return (
    <div className="min-h-screen bg-[rgb(224,241,231)]">
            ...
            >
              <div className="mb-8 md:mb-12">
                ...
                <h1 className="text-4xl md:text-8xl lg:text-9xl mb-4 md:mb-6 font-light tracking-wide" style={{ 
                  ...
                  <span className="mx-2 md:mx-8 text-[rgb(242,230,229)]">&</span>
                  <span className="italic">Conor</span>
                </h1>
                <p className="text-lg md:text-2xl font-light tracking-[0.2em] md:tracking-[0.3em] uppercase opacity-90">Are Getting Married</p>
              </div>

              {/* Immersive Date Display */}
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-12 mb-8 md:mb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
                  <div className="space-y-3 md:space-y-4">
                    <Calendar className="h-8 w-8 md:h-12 md:w-12 mx-auto opacity-80" />
                    <div>
                      <p className="text-xs md:text-sm uppercase tracking-[0.2em] opacity-70 mb-1 md:mb-2">Date</p>
                      <p className="text-lg md:text-2xl font-serif">Friday</p>
                      <p className="text-xl md:text-3xl font-serif">April 3rd, 2026</p>
                    </div>
                  </div>
                  <div className="space-y-3 md:space-y-4">
                    <MapPin className="h-8 w-8 md:h-12 md:w-12 mx-auto opacity-80" />
                    <div>
                      <p className="text-xs md:text-sm uppercase tracking-[0.2em] opacity-70 mb-1 md:mb-2">Location</p>
                      <p className="text-xl md:text-3xl font-serif">Mexico City</p>
                      <p className="text-base md:text-xl opacity-80">Mexico</p>
                    </div>
                  </div>
                  <div className="space-y-3 md:space-y-4">
                    <Users className="h-8 w-8 md:h-12 md:w-12 mx-auto opacity-80" />
                    <div>
                      <p className="text-xs md:text-sm uppercase tracking-[0.2em] opacity-70 mb-1 md:mb-2">Celebration</p>
                      <p className="text-xl md:text-3xl font-serif">Extended</p>
                      <p className="text-base md:text-xl opacity-80">Weekend</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-gradient-to-r from-[rgb(242,230,229)] to-[rgb(125,146,175)]">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8 md:mb-16">
              <h2 className="font-serif text-4xl md:text-6xl text-[rgb(88,104,127)] mb-4 md:mb-8 font-light">Welcome to Our Adventure</h2>
              <div className="w-16 md:w-24 h-px bg-[rgb(228,198,191)] mx-auto mb-4 md:mb-8"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
              <div className="space-y-6 md:space-y-8 text-left">
                ...
                <div className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-[rgb(228,198,191)]/30 shadow-lg mb-6 md:mb-8">
                  <div className="text-center">
                    <div className="flex items-center justify-center space-x-2 md:space-x-3 mb-3 md:mb-4">
                      <span className="text-xl md:text-2xl">💬</span>
                      <h3 className="text-xl md:text-2xl font-serif text-[rgb(88,104,127)]">Stay Updated</h3>
                    </div>
                    ...
                    <Button
                      ...
                      className="bg-green-500 hover:bg-green-600 text-white px-6 md:px-8 py-2 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 font-medium text-sm md:text-base"
                    >
              ...
              <div className="relative">
                <div className="absolute -inset-2 md:-inset-4 bg-gradient-to-r from-[rgb(125,146,175)] to-[rgb(228,198,191)] rounded-3xl transform rotate-3 opacity-20"></div>
      ...
      <section className="py-8 md:py-16 bg-white overflow-hidden">
        <div className="container mx-auto px-4 md:px-6 mb-8 md:mb-12">
          <div className="text-center">
            <h2 className="font-serif text-3xl md:text-5xl text-[rgb(88,104,127)] mb-3 md:mb-4 font-light">Our Adventures Together</h2>
        ...
        <div className="relative h-[600px] md:h-[900px] overflow-hidden">
                ...
                <div key={index} className="relative group shrink-0">
                  <div
                    className={`bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-xl ${
                      photo.size === "large"
                        ? "w-[200px] h-[150px] md:w-[350px] md:h-[250px]"
                        : photo.size === "square"
                          ? "w-[140px] h-[140px] md:w-[220px] md:h-[220px]"
                          : photo.size === "tall"
                            ? "w-[160px] h-[200px] md:w-[240px] md:h-[300px]"
                            : "w-[200px] h-[120px] md:w-[320px] md:h-[200px]" // wide
                    }`}
                  >
                    ...
                    <div className="relative bg-white p-2 md:p-3 rounded-2xl h-full">
                      <Image
          ...
          <div 
            className={`absolute top-[200px] md:top-[300px] flex animate-scroll-medium`}
            style={getAnimationStyle('row2')}
            onMouseEnter={() => setHoveredRow('row2')}
            onMouseLeave={() => setHoveredRow(null)}
          >
            <div className="flex space-x-3 md:space-x-6 shrink-0">
              {[
                ...
                <div key={index} className="relative group shrink-0">
                  <div
                    className={`bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-xl ${
                      photo.size === "large"
                        ? "w-[180px] h-[120px] md:w-[340px] md:h-[220px]"
                        : photo.size === "square"
                          ? "w-[120px] h-[120px] md:w-[200px] md:h-[200px]"
                          : photo.size === "tall"
                            ? "w-[120px] h-[160px] md:w-[200px] md:h-[280px]"
                            : "w-[180px] h-[100px] md:w-[300px] md:h-[180px]" // wide
                    }`}
                  >
          ...
          <div 
            className={`absolute top-[400px] md:top-[600px] flex animate-scroll-fast`}
            style={getAnimationStyle('row3')}
            onMouseEnter={() => setHoveredRow('row3')}
            onMouseLeave={() => setHoveredRow(null)}
          >
            <div className="flex space-x-3 md:space-x-7 shrink-0">
              {[
                ...
                <div key={index} className="relative group shrink-0">
                  <div
                    className={`bg-white rounded-2xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-xl ${
                      photo.size === "square"
                        ? "w-[130px] h-[130px] md:w-[210px] md:h-[210px]"
                        : photo.size === "tall"
                          ? "w-[130px] h-[170px] md:w-[210px] md:h-[270px]"
                          : "w-[190px] h-[110px] md:w-[310px] md:h-[190px]" // wide
                    }`}
                  >
        ...
        <div className="text-center mt-8 md:mt-12">
          <p className="text-[rgb(125,146,175)] font-light italic text-sm md:text-base">
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-[rgb(88,104,127)] relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-10 md:top-20 left-10 md:left-20 w-16 md:w-32 h-16 md:h-32 border border-white/10 rounded-full"></div>
          <div className="absolute bottom-10 md:bottom-20 right-10 md:right-20 w-12 md:w-24 h-12 md:h-24 border border-white/10 rounded-full"></div>
        </div>

        <div className="container mx-auto relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="font-serif text-4xl md:text-6xl text-white mb-4 md:mb-8 font-light">The Venue</h2>
              <p className="text-lg md:text-2xl text-[rgb(224,241,231)] font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
              <div className="relative">
                <div className="absolute -inset-3 md:-inset-6 bg-gradient-to-r from-[rgb(228,198,191)] to-[rgb(224,241,231)] rounded-3xl transform -rotate-2 opacity-20"></div>
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-[rgb(224,241,231)]">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="font-serif text-4xl md:text-6xl text-[rgb(88,104,127)] mb-4 md:mb-8 font-light">Explore Mexico City</h2>
              <p className="text-lg md:text-2xl text-[rgb(88,104,127)] font-light mb-3 md:mb-4">Easter Weekend Adventure</p>
              <p className="text-base md:text-lg text-[rgb(88,104,127)] font-light max-w-3xl mx-auto">
            ...
            {/* Suggested Itinerary */}
            <div className="mb-8 md:mb-16">
              <h3 className="text-2xl md:text-4xl font-serif text-[rgb(88,104,127)] text-center mb-8 md:mb-12 font-light">
                Suggested Long Weekend Itinerary
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                <div className="bg-white/60 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-[rgb(228,198,191)]/30">
                  <div className="text-center mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-[rgb(88,104,127)] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
                      <span className="text-white font-bold text-xs md:text-sm">WED</span>
                    </div>
                    <h4 className="text-base md:text-lg font-serif text-[rgb(88,104,127)] mb-1 md:mb-2">April 1st</h4>
                    <p className="text-xs md:text-sm text-[rgb(88,104,127)] uppercase tracking-wide">Arrival Day</p>
                  </div>
                  <ul className="text-xs md:text-sm text-[rgb(88,104,127)] space-y-1 md:space-y-2">
                ...
                <div className="bg-white/60 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-[rgb(228,198,191)]/30">
                  <div className="text-center mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-[rgb(125,146,175)] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
                      <span className="text-white font-bold text-xs md:text-sm">THU</span>
                    </div>
                    <h4 className="text-base md:text-lg font-serif text-[rgb(88,104,127)] mb-1 md:mb-2">April 2nd</h4>
                    <p className="text-xs md:text-sm text-[rgb(88,104,127)] uppercase tracking-wide">Explore Day</p>
                  </div>
                  <ul className="text-xs md:text-sm text-[rgb(88,104,127)] space-y-1 md:space-y-2">
                ...
                <div className="bg-white/60 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-[rgb(228,198,191)]/30 ring-2 ring-[rgb(228,198,191)]">
                  <div className="text-center mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-[rgb(228,198,191)] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
                      <Heart className="h-5 w-5 md:h-6 md:w-6 text-[rgb(88,104,127)] fill-current" />
                    </div>
                    <h4 className="text-base md:text-lg font-serif text-[rgb(88,104,127)] mb-1 md:mb-2">April 3rd</h4>
                    <p className="text-xs md:text-sm text-[rgb(88,104,127)] uppercase tracking-wide font-semibold">Wedding Day</p>
                  </div>
                  <ul className="text-xs md:text-sm text-[rgb(88,104,127)] space-y-1 md:space-y-2">
                ...
                <div className="bg-white/60 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-[rgb(228,198,191)]/30">
                  <div className="text-center mb-3 md:mb-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-[rgb(125,146,175)] rounded-full flex items-center justify-center mx-auto mb-2 md:mb-3">
                      <span className="text-white font-bold text-xs md:text-sm">SAT</span>
                    </div>
                    <h4 className="text-base md:text-lg font-serif text-[rgb(88,104,127)] mb-1 md:mb-2">April 4th</h4>
                    <p className="text-xs md:text-sm text-[rgb(88,104,127)] uppercase tracking-wide">Recovery Day</p>
                  </div>
                  <ul className="text-xs md:text-sm text-[rgb(88,104,127)] space-y-1 md:space-y-2">
            ...
            <div className="text-center mt-8 md:mt-12">
              ...
              <Link href="/guide">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-[rgb(88,104,127)] to-[rgb(125,146,175)] hover:from-[rgb(125,146,175)] hover:to-[rgb(88,104,127)] text-white px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg shadow-xl transform hover:scale-105 transition-all duration-300"
                >
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-gradient-to-br from-[rgb(242,230,229)] to-[rgb(125,146,175)]">
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-serif text-4xl md:text-6xl text-[rgb(88,104,127)] mb-8 md:mb-12 font-light">Ready for Takeoff?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-16">
              {[
                ...
                <div
                  key={index}
                  className="bg-white/60 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-[rgb(228,198,191)]/30 transform hover:scale-105 transition-all duration-300 hover:shadow-xl"
                >
                  ...
                  <h3 className="text-lg md:text-xl font-serif text-[rgb(88,104,127)] mb-3 md:mb-4">{item.title}</h3>
                  <p className="text-[rgb(88,104,127)] font-light text-sm md:text-base">{item.desc}</p>
                </div>
              ))}
            </div>

            <div className="bg-white/80 backdrop-blur-sm p-6 md:p-12 rounded-3xl border border-[rgb(228,198,191)]/30 shadow-2xl">
              <p className="text-lg md:text-xl text-[rgb(88,104,127)] mb-6 md:mb-8 font-light">
              ...
              <div className="space-y-4 md:space-y-6">
                <Button
                  size="lg"
                  disabled
                  className="bg-gray-400 text-gray-600 px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg shadow-xl mr-4 cursor-not-allowed opacity-50"
                >
                  Save Your Seat
                </Button>
                ...
                <Button
                  size="lg"
                  onClick={handleWhatsAppJoin}
                  className="bg-green-500 hover:bg-green-600 text-white px-8 md:px-12 py-3 md:py-4 rounded-full text-base md:text-lg shadow-xl transform hover:scale-105 transition-all duration-300 font-semibold"
                >
              ...
              <p className="text-xs md:text-sm text-[rgb(125,146,175)] mt-4 md:mt-6 font-light">
